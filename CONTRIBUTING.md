...
Before releasing:
* Consider doing a [test-deployment](https://github.com/xdev-software/xapi-db-hsql18/actions/workflows/test-deploy.yml?query=branch%3Adevelop) before actually releasing.
