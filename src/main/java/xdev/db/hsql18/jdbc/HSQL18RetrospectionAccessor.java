...
public class HSQL18RetrospectionAccessor extends StandardRetrospectionAccessor<HSQL18Dbms>
{
	
	public static final String RETROSPECTION_NOT_IMPLEMENTED_YET = "Retrospection not implemented yet!";
	
	public HSQL18RetrospectionAccessor(final HSQL18Dbms dbmsadaptor)
	{
		super(dbmsadaptor);
	}
